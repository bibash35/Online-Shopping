...
//     : '/path/to/default/image'; // fallback if no image provided
...
export default function CartProduct({ id, name, image, category, qty, total, price }) {
  ...
  // Otherwise, prefix with localhost server URL (adjust as per your backend)
  // If no image provided, use a default fallback image.
